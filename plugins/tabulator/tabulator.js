...
!(function (e, t) {
  ...
  class t {
    ...
    getParentColumn() {
      return (
        this._column.parent instanceof n && this._column.parent.getComponent()
      );
    }
    _getSelf() {
      return this._column;
  ...
  class n extends e {
    ...
    checkDefinition() {
      Object.keys(this.definition).forEach((e) => {
        -1 === n.defaultOptionList.indexOf(e) &&
          console.warn(
    ...
    _buildColumnHeader() {
      ...
      e.field && this.element.setAttribute("tabulator-field", e.field),
        ...
        e.maxInitialWidth &&
          (this.maxInitialWidth = parseInt(e.maxInitialWidth)),
    ...
    _buildColumnHeaderTitle() {
      ...
      if (
        (t.classList.add("tabulator-col-title"),
    ...
    generate(e, t = {}) {
      var i = Object.assign({}, this.registeredDefaults),
        s =
          ...
          !0 === t.debugInvalidOptions;
      Object.assign(i, e);
      for (let e in t)
        i.hasOwnProperty(e) ||
          (s && console.warn("Invalid " + this.msgType + " option:", e),
          (i[e] = t.key));
      for (let e in i)
        e in t
          ? (i[e] = t[e])
      ...
      return new Promise((a, l) => {
        if (s > -1) {
          if (
            ...
            !i &&
              r.elVisible(o) &&
              (n = r.elOffset(o).top - r.elOffset(this.elementVertical).top) >
                0 &&
              n < this.elementVertical.clientHeight - o.offsetHeight)
          )
            return a(), !1;
          switch (
            (void 0 === t && (t = this.table.options.scrollToRowPosition),
            "nearest" === t &&
              (t = this.scrollToRowNearestTop(e) ? "top" : "bottom"),
            this.scrollToRow(e),
            t)
          ) {
            case "middle":
            case "center":
              ...
              this.elementVertical.clientHeight
                ? (this.elementVertical.scrollTop =
                    this.elementVertical.scrollTop +
                    (o.offsetTop - this.elementVertical.scrollTop) -
                    (this.elementVertical.scrollHeight - o.offsetTop) / 2)
                : (this.elementVertical.scrollTop =
                    this.elementVertical.scrollTop -
            ...
            this.getVisibleRows().forEach((e) => {
              if ("group" !== e.type) {
                ...
                e
                  ...
                  .insertBefore(
                    t.getElement(),
                    e.getCell(this.columns[this.rightCol]).getElement()
                      .nextSibling
                  ),
                  t.cellRendered();
              }
      ...
      for (var e = !1, t = !0; t; ) {
        ...
        if (i)
          if (i.modules.vdomHoz.rightPos >= this.vDomScrollPosLeft) {
              ...
              this.getVisibleRows().forEach((e) => {
                if ("group" !== e.type) {
                  ...
                  e
                    ...
                    .insertBefore(
                      t.getElement(),
                      e.getCell(this.columns[this.leftCol]).getElement()
                    ),
                    t.cellRendered();
                }
              }),
            ...
            t &&
              ((this.scrollLeft = this.elementVertical.scrollLeft =
                this.elementVertical.scrollLeft + t),
              (this.vDomPadRight -= t));
          } else t = !1;
        else t = !1;
      }
  ...
  class c extends e {
    ...
    padVerticalScrollbar(e) {
      this.table.rtl
        ? (this.headersElement.style.marginLeft = e + "px")
        : (this.headersElement.style.marginRight = e + "px");
    }
    initializeRenderer() {
      var e,
        t = { virtual: d, basic: h };
    ...
    createHeaderContentsElement() {
      var e = document.createElement("div");
      return (
        e.classList.add("tabulator-header-contents"),
    ...
    _addColumn(e, t, i) {
      ...
      if (i && r > -1) {
        var a = i.getTopColumn(),
          ...
          h = a.getElement();
        t
          ? (this.columns.splice(l, 0, s), h.parentNode.insertBefore(o, h))
          : (this.columns.splice(l + 1, 0, s),
    ...
    rerenderColumns(e, t) {
      this.redrawBlock
        ? (!1 === e || (!0 === e && null === this.redrawBlockUpdate)) &&
          (this.redrawBlockUpdate = e)
        : this.renderer.rerenderColumns(e, t);
    }
    blockRedraw() {
      ...
      return new Promise((o, n) => {
        "string" == typeof e && (e = JSON.parse(e)),
          ...
          this.subscribed("row-data-changing") &&
            ((s = Object.assign(s, this.data)), (s = Object.assign(s, e))),
        ...
        for (let s in e) {
          this.table.columnManager.getColumnsByFieldRoot(s).forEach((e) => {
            ...
            if (s) {
              ...
              s.getValue() !== o &&
                (s.setValueProcessData(o), i && s.cellRendered());
            }
          });
        }
        i
  ...
  class m extends l {
    ...
    scrollToRowNearestTop(e) {
      ...
      return !(
        ...
        Math.abs(
          this.elementVertical.scrollTop + this.elementVertical.clientHeight - t
        )
      );
    }
    scrollToRow(e) {
      ...
      this.elementVertical.scrollTop =
        r.elOffset(t).top -
        r.elOffset(this.elementVertical).top +
        this.elementVertical.scrollTop;
    }
    visibleRows(e) {
      return this.rows();
  ...
  class g extends l {
    ...
    rerenderRows(e) {
      ...
      n.forEach((e) => {
        ...
        this.rows().length
          ...
          : (this.clear(), this.table.rowManager.tableEmpty()),
    ...
    _virtualRenderFill(e, t, i) {
      ...
      if (((i = i || 0), (e = e || 0))) {
        ...
        (l = (u - e + 1) * this.vDomRowHeight) < p &&
          (e -= Math.ceil((p - l) / this.vDomRowHeight)) < 0 &&
          (e = 0),
          (e -= n =
            Math.min(
              Math.max(
      ...
      if (u && r.elVisible(this.elementVertical)) {
        for (
          ...
          (a <= p + this.vDomWindowBuffer || d < this.vDomWindowMinTotalRows) &&
          this.vDomBottom < u - 1;
        ...
        e
          ...
          : ((this.vDomTopPad = 0),
            ...
            (this.vDomBottomPad =
              this.vDomRowHeight * (u - this.vDomBottom - 1)),
            (this.vDomScrollHeight = h + a + this.vDomBottomPad - p)),
          ...
          t &&
            (this.scrollTop =
              ...
              this.elementVertical.clientWidth
                ? this.elementVertical.offsetHeight - p
                : 0)),
          (this.scrollTop = Math.min(
            this.scrollTop,
            this.elementVertical.scrollHeight - p
          )),
          this.elementVertical.scrollWidth > this.elementVertical.clientWidth &&
            t &&
            (this.scrollTop += this.elementVertical.offsetHeight - p),
            ...
            ? ((l = d.getHeight() || this.vDomRowHeight),
              ...
              t >= l
                ? (this.styleRow(d, n),
                  ...
                  d.initialize(),
                  h ||
                    ((l = d.getElement().offsetHeight),
                    l > this.vDomWindowBuffer &&
    ...
    _removeTopRow(e, t) {
      for (var i = [], s = 0, o = 0, n = !0; n; ) {
        let r,
          a = e[this.vDomTop];
        a && o < this.vDomMaxRenderChain
          ? ((r = a.getHeight() || this.vDomRowHeight),
            t >= r
              ? (this.vDomTop++, (t -= r), (s += r), i.push(a), o++)
              : (n = !1))
          : (n = !1);
      }
      for (let e of i) {
    ...
    _removeBottomRow(e, t) {
      for (var i = [], s = 0, o = 0, n = !0; n; ) {
        ...
        a && o < this.vDomMaxRenderChain
          ? ((r = a.getHeight() || this.vDomRowHeight),
            t >= r
              ? (this.vDomBottom--, (t -= r), (s += r), i.push(a), o++)
              : (n = !1))
          : (n = !1);
      }
      for (let e of i) {
  ...
  class b extends e {
      ...
      if (e) {
        ...
        if ((t.classList.add("tabulator-placeholder"), "string" == typeof e)) {
          ...
          "undefined" != typeof HTMLElement && e instanceof HTMLElement
            ? (t.appendChild(e), (this.placeholderContents = e))
            : (console.warn(
    ...
    findRow(e) {
      if ("object" != typeof e) {
        ...
        return (
          this.rows.find((t) => t.data[this.table.options.index] == e) || !1
        );
      }
    ...
    getRowFromPosition(e) {
      return this.getDisplayRows().find(
        (t) => t.getPosition() === e && t.isDisplayed()
      );
    }
    scrollToRow(e, t, i) {
    ...
    addRows(e, t, i, s) {
      ...
      return new Promise((n, r) => {
        (t = this.findAddRowPos(t)),
          ...
          this.regenerateRowPositions(),
          o.length && this._clearPlaceholder(),
          n(o);
      });
    }
    findAddRowPos(e) {
    ...
    nextDisplayRow(e, t) {
      ...
      return (
        ...
        !s || (s instanceof p && "row" == s.type)
          ? s
          : this.nextDisplayRow(s, t)
      );
    }
    prevDisplayRow(e, t) {
      var i = this.getDisplayRowIndex(e),
      ...
      if (!this.table.destroyed) {
        if ("function" == typeof e)
          if ((n = this.dataPipeline.findIndex((t) => t.handler === e)) > -1)
            ...
            if (
              !(
                (n = this.displayPipeline.findIndex((t) => t.handler === e)) >
                -1
              )
            )
            ...
            (!this.redrawBlockRestoreConfig ||
              (this.redrawBlockRestoreConfig &&
                ((this.redrawBlockRestoreConfig.stage === o &&
                  n < this.redrawBlockRestoreConfig.index) ||
                  a.indexOf(o) <
    ...
    scrollBarCheck() {
      ...
      this.element.scrollHeight > this.element.clientHeight &&
        (e = this.element.offsetWidth - this.element.clientWidth),
        e !== this.scrollbarWidth &&
          ((this.scrollbarWidth = e), this.dispatch("scrollbar-vertical", e));
    }
    initializeRenderer() {
      var e,
        t = { virtual: g, basic: m };
    ...
    adjustTableSize() {
      ...
      if ("fill" === this.renderer.verticalFillMode) {
        ...
        this.fixedHeight
          ? ((e = isNaN(this.table.options.minHeight)
  ...
  class v extends e {
    ...
    bindPseudoEvents() {
      Object.keys(this.pseudoTrackers).forEach((e) => {
        (this.pseudoTrackers[e].subscriber = this.pseudoMouseEnter.bind(
          this,
          e
        )),
          ...
          switch (e) {
            ...
            case "column":
              s.components.includes("column") &&
                (i = this.table.columnManager.findColumn(r));
              break;
            case "cell":
              s.components.includes("cell") &&
                (o.row instanceof p
  ...
  class w {
    ...
    handle(e, t, i) {
      ...
      "then" === i ||
        "string" != typeof i ||
        i.startsWith("_") ||
        (this.table.options.debugInvalidComponentFuncs &&
          console.error(
            "The " +
              e +
  ...
  class R extends e {
    ...
    check(e, t) {
      ...
      return (
        ...
        t
          ? ((i = i + ", Please use the %c" + t + "%c option instead"),
            this._warnUser(
              i,
              "font-weight: bold;",
              "font-weight: normal;",
  ...
  class T extends e {
    ...
    child(e) {
      return (
        this.childPopup && this.childPopup.hide(),
        (this.childPopup = new T(this.table, e, this)),
        this.childPopup
      );
    }
  }
  class k extends e {
    ...
    displayRows(e) {
      ...
      if (
        (this._handler &&
          (t = this.table.rowManager.displayPipeline.findIndex(
            (e) => e.handler === this._handler
          )) > -1 &&
          (i = t),
        e && (i += e),
        this._handler)
        ...
        return i > -1
          ? this.table.rowManager.getDisplayRows(i)
          : this.activeRows();
    }
    activeRows() {
      ...
      e.forEach((e, t) => {
        ...
        n
          ? ((o = s - i + n.getWidth()),
            this.table.options.responsiveLayout &&
              this.table.modExists("responsiveLayout", !0) &&
              (n.setWidth(0), this.table.modules.responsiveLayout.update()),
            ...
            t
              ? ((s = u(t)),
                ...
                e.definition.widthShrink &&
                  (h.push({ column: e, width: s > i ? s : i }),
                  (d += e.definition.widthShrink)))
              : (l.push({ column: e, width: 0 }),
  ...
  class D extends k {
    ...
    initialize() {
      (this.langList = r.deepClone(D.langs)),
  ...
  class F {
    constructor(e, t) {
      this.bindStaticFunctionality(e),
        this.bindModules(e, z, !0),
  ...
  (_.moduleName = "accessor"), (_.accessors = {});
  function A(e, t) {
    var i = [];
    if (((t = t || ""), Array.isArray(e)))
      e.forEach((e, s) => {
        i = i.concat(A(e, t ? t + "[" + s + "]" : s));
      });
    else if ("object" == typeof e)
      for (var s in e) i = i.concat(A(e[s], t ? t + "[" + s + "]" : s));
  ...
  function V(e, t) {
    ...
    if (((t = t || ""), Array.isArray(e)))
      ...
      for (var s in e) i = i.concat(V(e[s], t ? t + "[" + s + "]" : s));
    else i.push({ key: t, value: e });
    return i;
  }
  var N = {
  ...
  class W extends k {
    ...
    initialize() {
      (this.loaderPromise =
        this.table.options.ajaxRequestFunc || W.defaultLoaderPromise),
        (this.urlGenerator =
          this.table.options.ajaxURLGenerator || W.defaultURLGenerator),
    ...
    setDefaultConfig(e = {}) {
      (this.config = Object.assign({}, W.defaultConfig)),
        "string" == typeof e
  ...
  class j extends k {
          ...
          this.table.element.addEventListener("copy", (e) => {
            ...
            this.blocked ||
              ...
              this.customSelection
                ...
                : ((s = this.table.modules.export.generateExportList(
                    this.table.options.clipboardCopyConfig,
                    this.table.options.clipboardCopyStyled,
                    this.rowRange,
                    "clipboard"
                  )),
                  (t = (i = this.table.modules.export.generateHTMLTable(s))
                    ? this.generatePlainContent(s)
                    : ""),
                  this.table.options.clipboardCopyFormatter &&
                    ((t = this.table.options.clipboardCopyFormatter(
                      "plain",
                      t
                    )),
                    (i = this.table.options.clipboardCopyFormatter(
                      "html",
                      i
                    )))),
    ...
    setPasteAction(e) {
      switch (typeof e) {
        case "string":
          (this.pasteAction = j.pasteActions[e]),
            this.pasteAction ||
    ...
    setPasteParser(e) {
      switch (typeof e) {
        case "string":
          (this.pasteParser = j.pasteParsers[e]),
            this.pasteParser ||
  ...
  class X extends k {
    ...
    initialize() {
      (this.genColumn = new n({ field: "value" }, this)),
        ...
        this.subscribe(
          "scrollbar-vertical",
          this.adjustForScrollbar.bind(this)
        ),
    ...
    restoreRedraw() {
      (this.blocked = !1),
        this.recalcAfterBlock &&
          ((this.recalcAfterBlock = !1), this.recalcActiveRowsRefresh());
    }
    userRecalc() {
    ...
    initializeColumn(e) {
      ...
      if (t.topCalc) {
        switch (typeof t.topCalc) {
          case "string":
            X.calculations[t.topCalc]
              ? (i.topCalc = X.calculations[t.topCalc])
              : console.warn(
      ...
      if (t.bottomCalc) {
        switch (typeof t.bottomCalc) {
          case "string":
            X.calculations[t.bottomCalc]
              ? (i.botCalc = X.calculations[t.bottomCalc])
              : console.warn(
                  "Column Calc Error - No such calculation found, ignoring: ",
                  t.bottomCalc
                );
    ...
    generateRow(e, t) {
      ...
      return (
        ...
        (i.component = !1),
        (i.getComponent = () => (
          i.component || (i.component = new G(i)), i.component
        )),
        (i.generateCells = () => {
          var t = [];
    ...
    adjustForScrollbar(e) {
      this.botRow &&
        (this.table.rtl
          ? (this.botElement.style.paddingLeft = e + "px")
          : (this.botElement.style.paddingRight = e + "px"));
    }
  }
  ...
  class q extends k {
    ...
    initializeRow(e) {
      ...
      !s &&
        ...
        (e.modules.dataTree = {
          ...
          controlEl:
            !(!e.modules.dataTree || !s) && e.modules.dataTree.controlEl,
    ...
    getTreeParentRoot(e) {
      return e.modules.dataTree && e.modules.dataTree.parent
  ...
  var K = {
    ...
    html: function (e, t, i) {
      this.modExists("export", !0) &&
        i(this.modules.export.generateHTMLTable(e), "text/html");
    },
  };
  class J extends k {
    constructor(e) {
  ...
  class $ {
    ...
    _inputBlur(e) {
      this.blurable &&
        (this.popup ? this.popup.hide() : this._resolveValue(!0));
    }
    _inputSearch() {
      this._clearChoices();
    }
    ...
    _scrollToValue(e) {
      ...
      var i = this.displayItems.find(
        (e) =>
          void 0 !== e.label &&
          e.label.toLowerCase().startsWith(this.filterTerm)
      );
      i && this._focusItem(i),
        (this.filterTimeout = setTimeout(() => {
          this.filterTerm = "";
    ...
    _ajaxRequest(e, t) {
      return (
        (e = I(e, {}, this.params.filterRemote ? { term: t } : {})),
        fetch(e)
          .then((e) =>
            e.ok
              ? e
      ...
      return (
        ...
        null != t &&
          (String(t).toLowerCase().indexOf(e) > -1 ||
            String(i).toLowerCase().indexOf(e) > -1)
      );
    }
    _clearList() {
    ...
    _resolveValue(e) {
      ...
      if ((this.popup && this.popup.hide(!0), this.params.multiselect))
        ...
        t = this.currentItems[0]
          ...
          : null ==
              (i = Array.isArray(this.initialValues)
  ...
  var Z = {
        ...
        for (let e in o.elementAttributes)
          "+" == e.charAt(0)
            ? ((e = e.slice(1)),
              r.setAttribute(
                e,
                r.getAttribute(e) + o.elementAttributes["+" + e]
              ))
        ...
        for (let e in o.elementAttributes)
          "+" == e.charAt(0)
            ? ((e = e.slice(1)),
              l.setAttribute(
                e,
                l.getAttribute(e) + o.elementAttributes["+" + e]
              ))
        ...
        for (let e in o.elementAttributes)
          "+" == e.charAt(0)
            ? ((e = e.slice(1)),
              a.setAttribute(
                e,
                a.getAttribute(e) + o.elementAttributes["+" + e]
              ))
        ...
        for (let e in o.elementAttributes)
          "+" == e.charAt(0)
            ? ((e = e.slice(1)),
              h.setAttribute(
                e,
                h.getAttribute(e) + o.elementAttributes["+" + e]
              ))
            : h.setAttribute(e, o.elementAttributes[e]);
      function c() {
        var e,
          t = h.value;
        if ((null == l && "" !== t) || t !== l) {
        ...
        for (let e in o.elementAttributes)
          "+" == e.charAt(0)
            ? ((e = e.slice(1)),
              d.setAttribute(
                e,
                d.getAttribute(e) + o.elementAttributes["+" + e]
              ))
            : d.setAttribute(e, o.elementAttributes[e]);
      function c() {
        var e,
          t = d.value;
        if ((null == h && "" !== t) || t !== h) {
        ...
        r &&
          (l
            ? ((n = l.isDateTime(h)
                ...
                ? l.fromISO(String(h))
                : l.fromFormat(String(h), r)),
              (h = n.toFormat("yyyy-MM-dd") + "T" + n.toFormat("hh:mm")))
            : console.error(
                "Editor Error - 'date' editor 'format' param is dependant on luxon.js"
              )),
        (d.value = h),
        ...
        for (let e in o.elementAttributes)
          "+" == e.charAt(0)
            ? ((e = e.slice(1)),
              c.setAttribute(
                e,
                c.getAttribute(e) + o.elementAttributes["+" + e]
              ))
        ...
        for (let e in o.elementAttributes)
          "+" == e.charAt(0)
            ? ((e = e.slice(1)),
              p.setAttribute(
                e,
                p.getAttribute(e) + o.elementAttributes["+" + e]
              ))
            : p.setAttribute(e, o.elementAttributes[e]);
      return (
        ...
        a.addEventListener("keydown", function (e) {
          switch (e.keyCode) {
            case 39:
              e.preventDefault(),
                (p.style.width = p.clientWidth + a.clientWidth / 100 + "px");
              break;
            case 37:
              e.preventDefault(),
                (p.style.width = p.clientWidth - a.clientWidth / 100 + "px");
    ...
    tickCross: function (e, t, i, s, o) {
      ...
      function u(e) {
        var t = r.checked;
        return (
          d && t ? (t = o.trueValue) : c && !t && (t = o.falseValue),
          a
            ? e
              ? h
                ? l
      ...
      return (
        ...
        "firefox" != this.table.browser &&
          ...
          t(function () {
            e._getSelf && r.focus({ preventScroll: !0 });
          }),
        (r.checked = d
          ? n === o.trueValue
  ...
  class Q extends k {
    ...
    updateCellClass(e) {
      this.allowEdit(e)
        ? e.getElement().classList.add("tabulator-editable")
        : e.getElement().classList.remove("tabulator-editable");
    }
    clearCellEdited(e) {
    ...
    navigatePrev(e = this.currentCell, t) {
      ...
      if (e) {
        ...
        if (
          ...
          (i = this.findPrevEditableCell(s, s.cells.length))
        )
    ...
    rowEditableCheck(e) {
      e.getCells().forEach((e) => {
        e.column.modules.edit &&
          "function" == typeof e.column.modules.edit.check &&
    ...
    allowEdit(e) {
      ...
      if (e.column.modules.edit)
        switch (typeof e.column.modules.edit.check) {
          case "function":
            e.row.initialized &&
              (t = e.column.modules.edit.check(e.getComponent()));
            break;
          case "string":
    ...
    edit(e, t, i) {
      ...
      if (!this.currentCell) {
        ...
        if ((t && t.stopPropagation(), this.allowEdit(e) || i)) {
          ...
          for (
            l.classList.add("tabulator-editing"),
              e.row.getElement().classList.add("tabulator-editing"),
              e.table.element.classList.add("tabulator-editing");
            l.firstChild;
  ...
  class ie extends k {
    ...
    columnVisCheck(e) {
      ...
      return (
        "function" == typeof t && (t = t.call(this.table, e.getComponent())),
        !1 !== t && (e.visible || (!e.visible && t))
      );
    }
        ...
        t.forEach((e) => {
          ...
          e.forEach((e) => {
            if (e) {
              ...
              t.push(
                new te(i, e.column.getComponent(), e.width, e.height, e.depth)
              );
            } else t.push(null);
          }),
      ...
      return (
        ...
        (e = e.filter((e) => {
          ...
          switch (e.type) {
            case "group":
              (r = e.level),
                n.push(new te(e.key, e.getComponent(), t.length, 1));
              break;
            case "calc":
            case "row":
              t.forEach((e) => {
      ...
      if (
        ...
        e.columns.forEach((o, n) => {
          if (o) {
            ...
            if (
              ((l.definition.cssClass
                ? l.definition.cssClass.split(" ")
                : []
              ).forEach(function (e) {
                a.classList.add(e);
              }),
              ...
              d = this.table.modules.format.formatExportValue(
                c,
                this.colVisProp
              );
            else
            ...
            d instanceof Node ? a.appendChild(d) : (a.innerHTML = d),
              ...
              this.table.options.dataTree &&
                !1 !== this.config.dataTree &&
                ((t.treeElementField && t.treeElementField == l.field) ||
                  (!t.treeElementField && 0 == n)) &&
              ...
              s.appendChild(a),
              c.modules.format &&
                c.modules.format.renderedCallback &&
                c.modules.format.renderedCallback();
          }
        }),
                    ...
                    ? ((r = e.definition.headerFilterFunc),
                      (o = function (i) {
                        ...
                        return (
                          ...
                          oe.filters[e.definition.headerFilterFunc](t, o, i, s)
                        );
                      }))
                    : console.warn(
        ...
        switch (
          ...
          case "boolean":
            e.modules.edit && e.modules.edit.editor
              ...
              : e.definition.formatter &&
                c.table.modules.edit.editors[e.definition.formatter]
          ...
          c.langBind(
            ...
            function (t) {
              n.setAttribute(
                ...
                void 0 !== t && t
                  ? t
                  : e.definition.headerFilterPlaceholder ||
                      c.langText("headerFilters|default")
              );
            }
          ),
            ...
            n.addEventListener("focus", (e) => {
              ...
              t !== this.table.rowManager.element.scrollLeft &&
  ...
  var ne = {
    ...
    progress: function (e, t = {}, i) {
      ...
      switch (
        ((n = parseFloat(h) <= c ? parseFloat(h) : c),
      ...
      (m.style.display = "inline-block"),
        ...
        (m.style.height = "100%"),
        m.setAttribute("data-max", c),
        m.setAttribute("data-min", u);
          ...
          n instanceof u
            ? (s.addEventListener("change", (e) => {
              ...
              "click" === this.table.options.selectableRangeMode &&
                s.addEventListener("click", (e) => {
                  (o = !0),
                    this.table.modules.selectRow.handleComplexRowClick(
                      n._row,
                      e
                    );
                }),
  ...
  class ae extends k {
    ...
    layoutGroupCalcs(e) {
      e.forEach((e) => {
        e.calcs.top && this.layoutRow(e.calcs.top),
          ...
          e.groupList &&
            e.groupList.length &&
            this.layoutGroupCalcs(e.groupList);
      });
    }
    ...
    layoutElement(e, t) {
      ...
      t.modules.frozen &&
        ...
        (i = this.table.rtl
          ? "left" === t.modules.frozen.position
            ? "right"
            : "left"
          : t.modules.frozen.position),
  ...
  class le extends k {
    ...
    initializeRow(e) {
      ...
      "number" === i
        ? e.getPosition() &&
          e.getPosition() + this.rows.length <= t &&
          this.freezeRow(e)
        : "function" === i
        ? t.call(this.table, e.getComponent()) && this.freezeRow(e)
        : Array.isArray(t) &&
          t.includes(e.data[this.options("frozenRowsField")]) &&
          this.freezeRow(e);
    }
    isRowFrozen(e) {
  ...
  class de {
    ...
    _addRowToGroup(e) {
      ...
      if (this.hasSubGroups) {
        ...
        this.groupManager.allowedValues && this.groupManager.allowedValues[t]
          ...
          : (this.groups[s] || this._createGroup(i, t),
    ...
    getHeadersAndRows() {
      ...
      return (
        ...
        this.calcs.bottom &&
          (this.calcs.bottom.detachElement(), this.calcs.bottom.deleteCells()),
        this.visible
          ? this.groupList.length
            ? this.groupList.forEach(function (t) {
    ...
    reinitialize() {
      (this.initialized = !1),
        (this.height = 0),
        r.elVisible(this.element) && this.initialize(!0);
    }
    setHeight(e) {
      this.height != e &&
  ...
  class ce extends k {
    ...
    setGroupBy(e) {
      (this.table.options.groupBy = e),
        ...
        !e &&
          this.table.modExists("columnCalcs") &&
          !0 === this.table.options.columnCalcs &&
    ...
    getChildGroups(e) {
      ...
      return (
        ...
        e.groupList.forEach((e) => {
          e.groupList.length
            ? (t = t.concat(this.getChildGroups(e)))
            : t.push(e);
        }),
        t
      );
    ...
    assignRowToGroup(e, t) {
      var i = this.groupIDLookups[0].func(e.getData()),
        s = !this.groups["0_" + i];
      return (
        s && this.createGroup(i, 0, t), this.groups["0_" + i].addRow(e), !s
      );
    }
  ...
  class ue extends k {
    ...
    rowDeleted(e) {
      var t, i;
      this.table.options.groupBy
        ? (t = (i = e.getComponent().getGroup()._getSelf().rows).indexOf(e)) &&
          (t = i[t - 1])
  ...
  class pe extends k {
    ...
    parseTable() {
      ...
      (this.hasIndex = !1),
        ...
        i.length
          ? this._extractHeaders(i, s)
          : this._generateBlankHeaders(i, s);
      for (var n = 0; n < s.length; n++) {
        ...
        for (var l = 0; l < r.length; l++) {
          ...
          void 0 !== this.fieldIndex[l] &&
            (a[this.fieldIndex[l]] = h.innerHTML);
        }
        o.push(a);
      }
  ...
  class ge extends k {
    ...
    loadDataCheck(e) {
      return (
        this.table.options.importFormat &&
        ("string" == typeof e ||
          (Array.isArray(e) && e.length && Array.isArray(e)))
      );
    }
    loadData(e, t, i, s, o) {
    ...
    lookupImporter(e) {
      ...
      return (
        ...
        (t = "string" == typeof e ? ge.importers[e] : e) ||
  ...
  class be extends k {
    ...
    cellContentsSelectionFixer(e, t) {
      ...
      if (
        ...
        this.table.modules.edit.currentCell !== t
      ) {
        e.preventDefault();
        try {
          document.selection
            ? ((i = document.body.createTextRange()).moveToElementText(
              ...
              i.select())
            : window.getSelection &&
              ((i = document.createRange()).selectNode(t.getElement()),
              window.getSelection().removeAllRanges(),
    ...
    dispatchEvent(e, t, i) {
      ...
      this.columnSubscribers[e] &&
        (i instanceof o
          ...
          : i instanceof n && (s = i.definition[e]),
        s && s(t, r)),
        this.dispatchExternal(e, t, r);
    }
  }
  ...
  class ve extends k {
    ...
    initializeRowWatchers() {
      this.table.options.rowContextMenu &&
        ...
        this.table.options.rowDblClickMenu &&
          this.subscribe(
            "row-dblclick",
    ...
    initializeGroupWatchers() {
      this.table.options.groupContextMenu &&
        ...
        this.table.options.groupDblClickMenu &&
          this.subscribe(
            "group-dblclick",
    ...
    initializeColumn(e) {
      ...
      t.headerContextMenu &&
        ...
        t.dblClickMenu &&
          ...
          ((this.columnSubscribers.dblClickMenu =
            this.loadMenuTableCellEvent.bind(this, "dblClickMenu")),
  ...
  class we extends k {
      ...
      e.modules.frozen ||
        ...
        (s.mousemove = function (s) {
          e.parent === i.moving.parent &&
            ((i.touchMove ? s.touches[0].pageX : s.pageX) -
              r.elOffset(t).left +
              i.table.columnManager.contentsElement.scrollLeft >
            e.getWidth() / 2
              ? (i.toCol === e && i.toColAfter) ||
                (t.parentNode.insertBefore(i.placeholderElement, t.nextSibling),
                i.moveColumn(e, !0))
              : (i.toCol !== e || i.toColAfter) &&
    ...
    startMove(e, t) {
      ...
      (this.moving = t),
        (this.startX =
          (this.touchMove ? e.touches[0].pageX : e.pageX) - r.elOffset(i).left),
        ...
        (this.hoverElement.style.bottom =
          s.clientHeight - o.offsetHeight + "px"),
        this.touchMove ||
          (this._bindMouseMove(),
    ...
    initializeGroupHeader(e) {
      ...
      (i.mouseup = function (i) {
        ...
        (i.mousemove = function (i) {
          var s;
          i.pageY -
            r.elOffset(e.element).top +
            t.table.rowManager.element.scrollTop >
          e.getHeight() / 2
            ? (t.toRow === e && t.toRowAfter) ||
              ((s = e.getElement()).parentNode.insertBefore(
                t.placeholderElement,
                s.nextSibling
              ),
              t.moveRow(e, !0))
            : (t.toRow !== e || t.toRowAfter) &&
              (s = e.getElement()).previousSibling &&
              (s.parentNode.insertBefore(t.placeholderElement, s),
              t.moveRow(e, !1));
        }.bind(t)),
        (e.modules.moveRow = i);
    }
    initializeRow(e) {
      ...
      (s.mouseup = function (t) {
        ...
        (s.mousemove = function (t) {
          var s = e.getElement();
          t.pageY - r.elOffset(s).top + i.table.rowManager.element.scrollTop >
          e.getHeight() / 2
            ? (i.toRow === e && i.toRowAfter) ||
              (s.parentNode.insertBefore(i.placeholderElement, s.nextSibling),
              i.moveRow(e, !0))
            : (i.toRow !== e || i.toRowAfter) &&
              (s.parentNode.insertBefore(i.placeholderElement, s),
              i.moveRow(e, !1));
        }.bind(i)),
        this.hasHandle ||
  ...
  class Re extends k {
    ...
    reset(e) {
      this.initialLoad ||
        (("local" == this.mode || e) && ((this.page = 1), this.trackChanges()));
    }
    setMaxPage(e) {
      (e = parseInt(e)),
        (this.max = e || 1),
    ...
    _setPageCounter(e, t, i) {
      ...
      if (this.pageCounter)
        switch (
          ...
          typeof (s = this.pageCounter.call(
            this,
            t,
            i,
            this.page,
      ...
      return (
        (t = t || []).forEach((t, s) => {
          ...
          n &&
            ...
            n.columns &&
              (n.columns = this.mergeDefinition(n.columns, t.columns)),
            i.push(n));
        }),
        e.forEach((e, s) => {
  ...
  (ke.moduleName = "persistence"),
    (ke.moduleInitOrder = -10),
    (ke.readers = xe),
    (ke.writers = Te);
  class Me extends k {
    constructor(e) {
    ...
    initializeRowWatchers() {
      this.table.options.rowContextPopup &&
        ...
        this.table.options.rowDblClickPopup &&
          this.subscribe(
            "row-dblclick",
    ...
    initializeGroupWatchers() {
      this.table.options.groupContextPopup &&
        ...
        this.table.options.groupDblClickPopup &&
          this.subscribe(
            "group-dblclick",
  ...
  class Le extends k {
    ...
    printFullscreen(e, t, i) {
      var s,
        ...
        h = this.table.modules.export.generateTable(
  ...
  class De extends k {
    ...
    frozenColumnOffset(e) {
      ...
      return (
        e.modules.frozen &&
          ((t = e.modules.frozen.marginValue),
          "left" === e.modules.frozen.position
            ? (t += e.getWidth() - 3)
            : t && (t -= 3)),
        !1 !== t && t + "px"
      );
    ...
    reinitializeColumn(e) {
      ...
      e.cells.forEach((i) => {
        i.modules.resize &&
          ...
          (t &&
            (i.modules.resize.handleEl.style[e.modules.frozen.position] = t),
          i.element.after(i.modules.resize.handleEl));
      }),
        e.modules.resize &&
          e.modules.resize.handleEl &&
          (t &&
            (e.modules.resize.handleEl.style[e.modules.frozen.position] = t),
    ...
    _mouseDown(e, t, i) {
      ...
      function o(e) {
        ...
        s.table.columnManager.rerenderColumns(!0),
          !s.table.browserSlow &&
            t.modules.resize &&
      ...
      function n(e) {
        s.startColumn.modules.edit && (s.startColumn.modules.edit.blocked = !1),
          ...
          s.startWidth !== t.getWidth() &&
            (s.table.columnManager.verticalAlignHeaders(),
  ...
  class ze extends k {
        ...
        (this.tableHeight = t.element.clientHeight),
          ...
          "virtual" === t.rowManager.getRenderMode()
                  ...
                  (this.tableHeight == i && this.tableWidth == s) ||
                    ...
                    t.element.parentNode &&
                      ((this.containerHeight =
                        t.element.parentNode.clientHeight),
                      (this.containerWidth = t.element.parentNode.clientWidth)),
                    this.redrawTable());
                }
              })),
            ...
            : ((this.binding = function () {
                (!t.browserMobile ||
                  (t.browserMobile && !t.modules.edit.currentCell)) &&
                  (t.columnManager.rerenderColumns(!0), t.redraw());
              }),
    ...
    initializeVisibilityObserver() {
      (this.visibilityObserver = new IntersectionObserver((e) => {
        (this.visible = e[0].isIntersecting),
          this.initialized
            ? this.visible &&
              (this.redrawTable(this.initialRedraw), (this.initialRedraw = !1))
            : ((this.initialized = !0), (this.initialRedraw = !this.visible));
      })),
    ...
    redrawTable(e) {
      this.initialized &&
        this.visible &&
        (this.table.columnManager.rerenderColumns(!0), this.table.redraw(e));
    }
    tableResized() {
      this.table.rowManager.redraw();
    }
    ...
    update() {
      for (var e = !0; e; ) {
        ...
        if (i < 0) {
          ...
          t && i > 0 && i >= t.getWidth()
            ? (this.showColumn(t), this.index--)
            : (e = !1);
        }
        this.table.rowManager.activeRowsCount ||
            ...
            if (
              ...
              (t = {
                ...
                s.push({
                  ...
                  value: o.modules.format.formatter.call(
                    this.table.modules.format,
                    t,
                    o.modules.format.params,
                    r
                  ),
                });
            } else
              s.push({ field: o.field, title: o.definition.title, value: n });
        }),
        s
      );
    }
  ...
  function Oe(e, t, i, s, o, n, r) {
    ...
    if (void 0 !== a) {
      if (
        (a.isDateTime(e) ||
          (e = "iso" === l ? a.fromISO(String(e)) : a.fromFormat(String(e), l)),
        a.isDateTime(t) ||
          (t = "iso" === l ? a.fromISO(String(t)) : a.fromFormat(String(t), l)),
        e.isValid)
      ) {
  ...
  var _e = {
    ...
    date: function (e, t, i, s, o, n, r) {
      return (
        ...
        Oe.call(this, e, t, i, s, o, n, r)
      );
    },
    time: function (e, t, i, s, o, n, r) {
      return (
        r.format || (r.format = "HH:mm"), Oe.call(this, e, t, i, s, o, n, r)
      );
    },
    datetime: Oe,
  ...
  class Ae extends k {
    ...
    initializeColumn(e) {
      ...
      switch (typeof e.definition.sorter) {
        case "string":
          Ae.sorters[e.definition.sorter]
            ? (s = Ae.sorters[e.definition.sorter])
            : console.warn(
    ...
    setColumnHeaderSortIcon(e, t) {
      ...
      if (
        e.definition.headerSort &&
        "function" == typeof this.table.options.headerSortElement
      ) {
        for (; s.firstChild; ) s.removeChild(s.firstChild);
        "object" ==
        typeof (i = this.table.options.headerSortElement.call(
          this.table,
          e.getComponent(),
          t
        ))
  ...
  (Ae.moduleName = "sort"), (Ae.sorters = _e);
  class Be extends k {
    constructor(e) {
      super(e),
  ...
  var Ie = {
    integer: function (e, t, i) {
      return (
        "" === t ||
        null == t ||
        ((t = Number(t)), !isNaN(t) && isFinite(t) && Math.floor(t) === t)
      );
    },
    float: function (e, t, i) {
      return (
        "" === t ||
        null == t ||
        ((t = Number(t)), !isNaN(t) && isFinite(t) && t % 1 != 0)
      );
    },
    ...
    in: function (e, t, i) {
      return (
        "" === t ||
        null == t ||
        ("string" == typeof i && (i = i.split("|")), i.indexOf(t) > -1)
      );
    },
